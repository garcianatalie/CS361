...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		// It prints "PART TIME EMPLOYEE" because of polymorphism, it was an employee object 
		// that was casted to PartTimeEmployee.
		...
		// because ...
		// emp1 is not an instance of part time employee, it is part of employee
